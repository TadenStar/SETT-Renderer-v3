"""Запуск рендера через QProcess (раздел 4.4 спеки).

Единственное место в core с импортом Qt: спека требует QProcess для живого
чтения stdout без подвисаний UI. Очередь, chunking и resume добавятся в M5.
"""
